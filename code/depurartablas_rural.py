...
columnas_a_eliminar = {
    'R_NOMENCLATURA_VIAL': ['Shape', 'USUARIO_LO', 'FECHA_LOG', 'GLOBALID_S', 'GLOBALID', 'CODIGO_MUN'],
    'R_CONSTRUCCION': ['Shape', 'OBJECTID', 'USUARIO_LO', 'FECHA_LOG', 'GLOBALID_S', 'GLOBALID', 'CODIGO_MUN'],
    'R_VEREDA': ['Shape', 'OBJECTID', 'USUARIO_LO', 'FECHA_LOG', 'GLOBALID_S', 'GLOBALID', 'SHAPE_Leng', 'CODIGO_MUN'],
    'R_TERRENO': ['Shape', 'OBJECTID', 'NUMERO_SUB', 'USUARIO_LO', 'FECHA_LOG', 'GLOBALID_S', 'GLOBALID', 'CODIGO_MUN', 'SHAPE_Leng']
}
