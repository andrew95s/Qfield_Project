...
for subcarpeta in ruta_base.iterdir():
    if subcarpeta.is_dir():
        ...
        # Cargar la ortofoto
        ruta_ortofoto = subcarpeta / "ortofoto"
        ...
        nombres_shapefiles = ["U_MANZANA", "U_TERRENO", "U_CONSTRUCCION", "U_NOMENCLATURA_VIAL"]
        ...
        nombre_proyecto = f"{subcarpeta.name}_Urbano.qgs"
